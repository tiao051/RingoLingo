...
final Widget coViet = Image.asset('assets/images/coViet.png', width: 80, height: 80);
final Widget coAnh = Image.asset('assets/images/coAnh.png', width: 80, height: 80);
final Widget coNhat = Image.asset('assets/images/coNhat.png', width: 80, height: 80);
final Widget coTrung = Image.asset('assets/images/coTrung.png', width: 80, height: 80);
            ...
            child: Row( 
              children: [ 
                Expanded( 
                  child: Column( 
                    children: [ 
                      _buildSkillCard('NGHE', 'Luyện nghe với\nnội dung thực tế', Icons.headphones), 
                      const SizedBox(height: 20), 
                      _buildSkillCard('NÓI', 'Phát âm chuẩn\nvới AI coach', Icons.mic), 
                    ], 
                  ), 
                ), 
                const SizedBox(width: 20), 
                Expanded( 
                  child: Column( 
                    children: [ 
                      _buildSkillCard('ĐỌC', 'Đọc hiểu qua\ncâu chuyện thú vị', Icons.book), 
                      const SizedBox(height: 20), 
                      _buildSkillCard('VIẾT', 'Luyện viết từ cơ bản\nđến nâng cao', Icons.edit), 
                    ], 
                  ), 
                ), 
              ], 
  ...
  Widget _buildFooter() {
    return Container(
      ...
      child: Image.asset(
        ...
        fit: BoxFit.cover,  // Tùy chọn: BoxFit.cover, BoxFit.fitWidth, BoxFit.contain tùy bạn muốn ảnh hiển thị thế nào
      ),
    );
  }
}